...
import 'presentation/expenses_list/account_expenses_list.screen.robot.dart';
...
class AccountsRobot {
  AccountsRobot(this.tester)
      : list = AccountsListScreenRobot(tester),
        ...
        expensesList = AccountExpensesListRobot(tester);
  ...
  final AccountExpensesListRobot expensesList;
}
