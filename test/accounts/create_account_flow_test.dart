...
void main() {
  testWidgets('create account flow', (tester) async {
    ...
    await r.accounts.openCreateAccount();
    // 2. enter account name
    await r.accounts.setAccountName(accountName);
    // 3. tap on create account button
    await r.accounts.tapCreateAccount();
    // 4. expect to see the new account in the list
    r.accounts.expectFindAccount(accountName);
  });
}
